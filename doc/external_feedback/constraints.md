...
`0xffffffff` query allowed, ABI-switch forms killed. *(Superseded 2026-08-31: refused with `EINVAL` rather than killed — see `doc/constraints.md`. This file is a filed copy and is not maintained.)*
