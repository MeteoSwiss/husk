...
if [ "$checked" -eq 0 ]; then
  ...
  echo "parity: all $checked allowed query options exist in the real tools [expect]"
else
  echo "parity: $bad of $checked allowed query options do not exist in the real tools"
fi
